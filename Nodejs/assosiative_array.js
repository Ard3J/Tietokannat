...
//ekan kirjan nimi tulostus
console.log("Ensimmäinen kirja: "+bookData[0].name);

//rivien määrä
console.log("Rivien määrä: "+bookData.length);

//kaikkien kirjojen nimet
nimet = bookData.map(item => " "+item.name);
console.log("Kaikkien kirjojen nimet:"+nimet);